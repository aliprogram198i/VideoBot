"""Production entrypoint with canonical admin statistics bootstrap."""
...
def main() -> None:
    ...
    register_admin_stats = importlib.import_module(
        "plugins.admin_stats_consistency"
    ).register_admin_stats_consistency

    register_admin_stats(bot_module)
    print("📊 Canonical admin statistics: ENABLED", flush=True)
