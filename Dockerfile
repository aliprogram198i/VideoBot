...
RUN test -s /opt/yt-dlp-plugins/yt_dlp_plugins/extractor/threads.py \
    && python -m py_compile bot.py entrypoint.py downloader/error_reporter.py plugins/manager.py plugins/core_runtime.py plugins/admin_control_center.py plugins/broadcast_media.py plugins/group_broadcast.py plugins/miniapp.py
