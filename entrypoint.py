...
def main() -> None:
    ...
    try:
        ...
        install_shhaiid4u_provider_browser_handoff = importlib.import_module("downloader.shhaiid4u_provider_browser_handoff").install
        ...
        # Keep all Shhaiid4u layers isolated. Install older layers first;
        # provider browser handoff becomes the outermost Shhaiid4u wrapper.
        ...
        install_shhaiid4u_provider_browser_handoff(bot_module)
