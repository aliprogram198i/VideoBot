...
def main() -> None:
    ...
    try:
        ...
        # Keep Shhaiid4u discovery isolated, then hand discovered provider URLs
        # to one canonical provider router. Provider-specific browser handoff
        # wrappers are intentionally not stacked around this boundary.
