...
def main() -> None:
    ...
    try:
        ...
        # Install provider-specific discovery before the generic Smart Media
        # Bridge captures extract_direct_media_urls. It is isolated to
        # shhaiid4u.net and falls through to the existing chain on failure.
