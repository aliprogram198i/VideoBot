...
def main() -> None:
    ...
    try:
        ...
        install_shhaiid4u_browser_provider_handoff = importlib.import_module("downloader.shhaiid4u_browser_provider_handoff").install
        ...
        # the provider downloader becomes an inner provider-specific fallback,
        # while the browser provider handoff becomes the outermost download path.
        ...
        install_shhaiid4u_browser_provider_handoff(bot_module)
