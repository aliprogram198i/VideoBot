...
_MESSAGES = {
    "smart_search": {
        "ar": {
            ...
            "selected": {"ar": "🎯 <b>تم اختيار:</b>", "en": "🎯 <b>Selected:</b>", "tr": "🎯 <b>Seçildi:</b>", "de": "🎯 <b>Ausgewählt:</b>"}["ar"],
            "opening": {"ar": "🎛️ جاري فتح لوحة التحكم...", "en": "🎛️ Opening download controls...", "tr": "🎛️ İndirme denetimleri açılıyor...", "de": "🎛️ Download-Steuerung wird geöffnet..." }["ar"],
            "retry": {"ar": "🔄 إعادة المحاولة", "en": "🔄 Retry", "tr": "🔄 Tekrar dene", "de": "🔄 Erneut versuchen"},
            "retry_failed": {"ar": "❌ تعذر فتح لوحة التحميل لهذه النتيجة حالياً.\n\nيمكنك الضغط على النتيجة مرة أخرى للمحاولة.", "en": "❌ Download controls could not be opened for this result right now.\n\nYou can select the result again to retry.", "tr": "❌ Bu sonuç için indirme denetimleri şu anda açılamıyor.\n\nTekrar denemek için sonucu yeniden seçebilirsiniz.", "de": "❌ Die Download-Steuerung für dieses Ergebnis konnte derzeit nicht geöffnet werden.\n\nSie können das Ergebnis erneut auswählen."},
        },
        "en": {
            ...
            "selected": {"ar": "🎯 <b>تم اختيار:</b>", "en": "🎯 <b>Selected:</b>", "tr": "🎯 <b>Seçildi:</b>", "de": "🎯 <b>Ausgewählt:</b>"}["de"],
            "opening": {"ar": "🎛️ جاري فتح لوحة التحكم...", "en": "🎛️ Opening download controls...", "tr": "🎛️ İndirme denetimleri açılıyor...", "de": "🎛️ Download-Steuerung wird geöffnet..." }["de"],
            "retry": {"ar": "🔄 إعادة المحاولة", "en": "🔄 Retry", "tr": "🔄 Tekrar dene", "de": "🔄 Erneut versuchen"},
            "retry_failed": {"ar": "❌ تعذر فتح لوحة التحميل لهذه النتيجة حالياً.\n\nيمكنك الضغط على النتيجة مرة أخرى للمحاولة.", "en": "❌ Download controls could not be opened for this result right now.\n\nYou can select the result again to retry.", "tr": "❌ Bu sonuç için indirme denetimleri şu anda açılamıyor.\n\nTekrar denemek için sonucu yeniden seçebilirsiniz.", "de": "❌ Die Download-Steuerung für dieses Ergebnis konnte derzeit nicht geöffnet werden.\n\nSie können das Ergebnis erneut auswählen."},
            "selected": {"ar": "🎯 <b>تم اختيار:</b>", "en": "🎯 <b>Selected:</b>", "tr": "🎯 <b>Seçildi:</b>", "de": "🎯 <b>Ausgewählt:</b>"}["tr"],
            "opening": {"ar": "🎛️ جاري فتح لوحة التحكم...", "en": "🎛️ Opening download controls...", "tr": "🎛️ İndirme denetimleri açılıyor...", "de": "🎛️ Download-Steuerung wird geöffnet..." }["tr"],
            "retry": {"ar": "🔄 إعادة المحاولة", "en": "🔄 Retry", "tr": "🔄 Tekrar dene", "de": "🔄 Erneut versuchen"},
            "retry_failed": {"ar": "❌ تعذر فتح لوحة التحميل لهذه النتيجة حالياً.\n\nيمكنك الضغط على النتيجة مرة أخرى للمحاولة.", "en": "❌ Download controls could not be opened for this result right now.\n\nYou can select the result again to retry.", "tr": "❌ Bu sonuç için indirme denetimleri şu anda açılamıyor.\n\nTekrar denemek için sonucu yeniden seçebilirsiniz.", "de": "❌ Die Download-Steuerung für dieses Ergebnis konnte derzeit nicht geöffnet werden.\n\nSie können das Ergebnis erneut auswählen."},
            "selected": {"ar": "🎯 <b>تم اختيار:</b>", "en": "🎯 <b>Selected:</b>", "tr": "🎯 <b>Seçildi:</b>", "de": "🎯 <b>Ausgewählt:</b>"}["en"],
            "opening": {"ar": "🎛️ جاري فتح لوحة التحكم...", "en": "🎛️ Opening download controls...", "tr": "🎛️ İndirme denetimleri açılıyor...", "de": "🎛️ Download-Steuerung wird geöffnet..." }["en"],
            "retry": {"ar": "🔄 إعادة المحاولة", "en": "🔄 Retry", "tr": "🔄 Tekrar dene", "de": "🔄 Erneut versuchen"},
            "retry_failed": {"ar": "❌ تعذر فتح لوحة التحميل لهذه النتيجة حالياً.\n\nيمكنك الضغط على النتيجة مرة أخرى للمحاولة.", "en": "❌ Download controls could not be opened for this result right now.\n\nYou can select the result again to retry.", "tr": "❌ Bu sonuç için indirme denetimleri şu anda açılamıyor.\n\nTekrar denemek için sonucu yeniden seçebilirsiniz.", "de": "❌ Die Download-Steuerung für dieses Ergebnis konnte derzeit nicht geöffnet werden.\n\nSie können das Ergebnis erneut auswählen."},
        },
        "tr": {
