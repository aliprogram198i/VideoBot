...
_CARD_TEXTS = {
    "ar": {
        ...
        "status": "الحالة",
        "partial": "تم فحص الرابط، لكن بعض المعلومات غير متاحة.",
        "ready": "تم فحص الرابط، وهو جاهز للتحميل.",
        "choose": "اختر ما تريد:",
        "video": "🎥 فيديو",
        "post": "📌 تحميل المنشور",
        "audio": "🎵 MP3",
        ...
        "cancel": "❌ إلغاء",
        "open": "🔗 فتح الرابط",
        "analyzing": "🔎 جاري فحص الرابط وتحليل محتواه...",
    ...
    "en": {
        ...
        "status": "Status",
        "partial": "The link was checked, but some information is unavailable.",
        "ready": "The link was checked and is ready to download.",
        ...
        "cancel": "❌ Cancel",
        "open": "🔗 Open link",
        "analyzing": "🔎 Checking and analyzing the link...",
    ...
    "tr": {
        ...
        "status": "Durum",
        "partial": "Bağlantı kontrol edildi, ancak bazı bilgiler alınamadı.",
        "ready": "Bağlantı kontrol edildi ve indirmeye hazır.",
        ...
        "cancel": "❌ İptal",
        "open": "🔗 Bağlantıyı aç",
        "analyzing": "🔎 Bağlantı kontrol ediliyor ve analiz ediliyor...",
    ...
    "de": {
        ...
        "status": "Status",
        "partial": "Der Link wurde geprüft, aber einige Informationen sind nicht verfügbar.",
        "ready": "Der Link wurde geprüft und ist zum Download bereit.",
        ...
        "cancel": "❌ Abbrechen",
        "open": "🔗 Link öffnen",
        "analyzing": "🔎 Link wird geprüft und analysiert...",
