...
def admin_keyboard():
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🚨 Error & Incident Center", callback_data="admin_incidents"),
         InlineKeyboardButton("🌐 Platform / Resolver Monitor", callback_data="admin_resolver_monitor")],
        [InlineKeyboardButton("🔔 Admin Alerts", callback_data="admin_alerts"),
